<div class="p-6 min-h-screen w-full">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md flex items-center justify-between">
            ...
            <a href="{{ route('news.manager') }}" wire:navigate class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">View</a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md flex items-center justify-between">
            ...
            <a href="{{ route('event.manager') }}" wire:navigate class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">View</a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md flex items-center justify-between">
            ...
            <a href="{{ route('tutorial.manager') }}" wire:navigate class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">View</a>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 p-5 rounded-lg shadow-md flex items-center justify-between">
            ...
            <a href="{{ route('crop.solution.manager') }}" wire:navigate class="text-sm text-indigo-600 dark:text-indigo-400 hover:underline">View</a>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                ...
                @endforelse {{-- <-- This was the line with the typo --}}
            </ul>
