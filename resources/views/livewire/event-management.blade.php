                ...
                <div class="mt-3">
                    ...
                    <form wire:submit.prevent="save">
                        <div class="space-y-4">
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Event
                                    Image</label>
...
                                            hover:file:bg-blue-100">
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Location
                                    (Optional)</label>
                            ...
                            <div>
                                <label
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Capacity
                                    (Optional)</label>
