...
@section('content')
    ...
    <section class="relative bg-linear-to-br from-lime-600 via-lime-500 to-emerald-500 text-white py-24 overflow-hidden">
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(255,255,255,0.1)_0%,transparent_50%)]">
        </div>
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(255,255,255,0.1)_0%,transparent_50%)]">
        </div>
    ...
    {{-- Events List --}}
    <div class="space-y-8 mx-4 md:mx-8 lg:mx-16 mb-24 md:mb-16">
        @forelse ($events as $event)
            <div
                ...
                {{-- Date Box (Left Side) --}}
                <div
                    class="md:w-48 bg-green-600 text-white flex flex-col items-center justify-center p-6 text-center shrink-0">
                ...
                <div class="p-6 flex-1 flex flex-col justify-between">
                    ...
                    <div class="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                        ...
                        <a href="{{ route('events.show', $event->id) }}"
                            class="text-green-600 font-semibold hover:text-green-800 text-sm">
                            View Details &rarr;
                        </a>
                    </div>
                </div>
