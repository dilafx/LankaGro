...
<div class="py-12 bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-10">
            <h1 class="text-3xl font-bold text-green-900">Crop Fertilizer Calculator</h1>
            <p class="mt-2 text-gray-600">Estimate the nutrient requirements for your cultivation area.</p>
        </div>
