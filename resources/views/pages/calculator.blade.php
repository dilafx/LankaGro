                    ...
                    <form id="calculatorForm" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative rounded-md shadow-sm">
                                    <input type="number" name="area" id="area"
                                        class="focus:ring-green-500 focus:border-green-500 block w-full pl-3 pr-12 sm:text-sm border-gray-300 rounded-md py-2 border"
                        ...
                        <div class="flex justify-end">
                            <button type="button" onclick="calculateFertilizer()"
                                class="inline-flex justify-center py-2 px-6 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
                    ...
                    <div id="results" class="mt-10 hidden border-t border-gray-200 pt-8">
                        ...
                        <p class="mt-4 text-xs text-gray-500 text-center">
                            *Disclaimer: These figures are approximate estimations based on general standards. Please
                            consult an agricultural extension officer for precise recommendations based on your soil type.
                        </p>
                    </div>
